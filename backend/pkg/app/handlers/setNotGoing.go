...
func SetNotGoingHandler(w http.ResponseWriter, r *http.Request) {
	if r.Method != "POST" {
	...
	if err := dbfunctions.SetUserEventAnswer(models.InvitedMember{EventId: req.EventId, MemberId: user.Id, Answer: 1}); err != nil {
